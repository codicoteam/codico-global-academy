...
const AddPaymentPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://codico-global-academy-backend.onrender.com/api/v1/pay_course/web-paynow-me", {
      ...
      <div className="relative z-1 mx-auto max-w-4xl px-8 py-10 lg:px-16 lg:py-14 xl:px-20 xl:py-16 bg-white dark:bg-black rounded-xl shadow-lg">
        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4">
              <input type="text" name="customerName" placeholder="Customer Name" value={data.customerName} onChange={handleChange} className="p-3 border rounded-lg bg-gray-50 dark:bg-gray-800" />
              <input type="text" name="customerEmail" placeholder="Customer Email" value={data.customerEmail} onChange={handleChange} className="p-3 border rounded-lg bg-gray-50 dark:bg-gray-800" />
